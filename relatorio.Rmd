...
```
Entretanto, parece que o nível de escolaridade das mulheres "vale menos", pois considerando os 4 principais níveis escolares (bacharel, pós, mestrado e doutorado) as mulheres que os possuem estão menos presentes, proporcionalmente, nos cargos sênior e de gestão, do que os homens.
```{r}
