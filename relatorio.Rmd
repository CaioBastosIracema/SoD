...
df%>%
  ...
  ggrepel::geom_label_repel(ggplot2::aes(
    ...
    size=3.5) +
  ggplot2::ggtitle('Atuação x Gênero')+
  ggplot2::theme_void()+
...
df%>%
  ...
  ggrepel::geom_label_repel(ggplot2::aes(
    ...
    position = ggplot2::position_stack(vjust = .5),
    size=3.5) +
  ggplot2::ggtitle('Nível de Cargo x Atuação x Gênero')+
  ggplot2::theme_void()+
...
```
O curioso é o fato das mulheres serem mais escolarizadas que os homens e quem diz isso é o IBGE. Os dados constam da segunda edição do estudo "Estatísticas de gênero: indicadores sociais das mulheres no Brasil". Ele traz informações variadas sobre as condições de vida das brasileiras em 2019  https://epocanegocios.globo.com/Economia/noticia/2021/03/epoca-negocios-mulheres-sao-mais-instruidas-mas-ocupam-apenas-374-dos-cargos-gerenciais.html . O estudo ainda trás outros dados, como a maior dificuldade das mulheres em acessar cargos de chefia e gerência (corroborando com o gráfico mostrado anteriormente), além do rendimento médio inferior a 80% do rendimento dos homens (de acordo com o relatório do State of Data Brazil 2021, as mulheres da área de dados estão ganhando menos nos cargos sênior e de gestão). 
Também é possível verificar isso na área de dados, mais precisamente com a pesquisa State of Data Brazil 2021, onde, considerando as funções de análise de dados e engenharia de dados, a proporção das mulheres entrevistadas que não possuem o nível de pós-graduação é menor que a dos homens na mesma situação, já entre os cientistas de dados, há equilíbrio neste quesito, embora quando passamos a analisar pessoas com, pelo menos, o nível de graduação, a proporção das mulheres volta a ser superior.
...
df%>%
  ...
  ggrepel::geom_label_repel(ggplot2::aes(
    ...
    position = ggplot2::position_stack(vjust = .5),
    size=3.5) +
  ggplot2::ggtitle('Nível de Ensino x Atuação x Gênero')+
  ggplot2::theme_void()+
...
df%>%
  ...
  ggrepel::geom_label_repel(ggplot2::aes(
    ...
    position = ggplot2::position_stack(vjust = .5),
    size=3.5) +
  ggplot2::ggtitle('Nível de Ensino x Nível de Cargo x Gênero')+
  ggplot2::theme_void()+
  ggplot2::scale_fill_brewer(type = "seq", palette = "BuPu")+
  ggplot2::xlab('Gênero')+
  ggplot2::theme(legend.position="bottom",
...
df%>%
  ...
  ggrepel::geom_label_repel(ggplot2::aes(
    ...
    position = ggplot2::position_stack(vjust = .5),
    size=3.5) +
  ggplot2::labs(title = 'Formação x Gênero')+
  ggplot2::theme_void()+
...
ggrepel::geom_label_repel(ggplot2::aes(label = scales::percent(Prop)),
                          ...
                          position = ggplot2::position_stack(vjust = .5),
                          size=3.5) +
  ggplot2::ggtitle('Nível de Cargo x Nível de Ensino x Gênero')+
  ggplot2::theme_void()+
  ggplot2::scale_fill_brewer(type = "seq", palette = "Oranges")+
  ggplot2::xlab('Gênero')+
  ggplot2::theme(legend.position="bottom",
...
plot1=SoDfiltrado%>%
  ...
  ggrepel::geom_label_repel(ggplot2::aes(
    ...
    position = ggplot2::position_stack(vjust = .5),
    size=3.5) +
  ggplot2::ggtitle('Experiência na área de dados x Gênero')+
  ggplot2::theme_void()+
...
plot2=SoDfiltrado%>%
  ...
  ggrepel::geom_label_repel(ggplot2::aes(
    ...
    position = ggplot2::position_stack(vjust = .5),
    size=3.5) +
  ggplot2::ggtitle('Experiência na área de TI x Gênero')+
  ggplot2::theme_void()+
...
df%>%
  ...
  ggrepel::geom_label_repel(ggplot2::aes(
    ...
    position = ggplot2::position_stack(vjust = .5),
    size=3.5) +
  ggplot2::ggtitle('Experiência na área de dados x Nível de Cargo x Gênero')+
  ggplot2::theme_void()+
  ggplot2::scale_fill_brewer(type = "seq", palette = "RdPu")+
  ggplot2::xlab('Gênero')+
  ggplot2::theme(legend.position="bottom",
...
df%>%
  ...
  ggrepel::geom_label_repel(ggplot2::aes(
    ...
    position = ggplot2::position_stack(vjust = .5),
    size=3.5) +
  ggplot2::ggtitle('Experiência na área de TI x Nível de Cargo x Gênero')+
  ggplot2::theme_void()+
  ggplot2::scale_fill_brewer(type = "seq", palette = "PuRd")+
  ggplot2::xlab('Gênero')+
  ggplot2::theme(legend.position="bottom",
...
```
Entre os analistas e, principalmente, cientistas de dados, há equilíbrio entre os gêneros em termos de experiência na área. Já entre os engenheiros de dados, a vantagem é ampla dos homens, sendo 26,79% das mulheres possuindo o mínimo de 4 anos de vivência na área,  enquanto que os homens entrevistados aparecem com 41,3%.
...
df%>%
  ...
  ggrepel::geom_label_repel(ggplot2::aes(
    ...
    position = ggplot2::position_stack(vjust = .5),
    size=3.5) +
  ggplot2::ggtitle('Experiência na área de dados x Atuação x Gênero')+
  ggplot2::theme_void()+
  ggplot2::scale_fill_brewer(type = "seq", palette = "RdPu")+
  ggplot2::xlab('Gênero')+
  ggplot2::theme(legend.position="bottom",
...
df%>%
  ...
  ggrepel::geom_label_repel(ggplot2::aes(
    ...
    position = ggplot2::position_stack(vjust = .5),
    size=3.5) +
  ggplot2::ggtitle('Experiência na área de TI x Atuação x Gênero')+
  ggplot2::theme_void()+
  ggplot2::scale_fill_brewer(type = "seq", palette = "PuRd")+
  ggplot2::xlab('Gênero')+
  ggplot2::theme(legend.position="bottom",
...
df%>%
  ...
  ggrepel::geom_label_repel(ggplot2::aes(
    ...
    position = ggplot2::position_stack(vjust = .5),
    size=3.5) +
  ggplot2::ggtitle('Faixa de Idade x Nível de Cargo x Gênero')+
  ggplot2::theme_void()+
...
df%>%
  ...
  ggrepel::geom_label_repel(ggplot2::aes(
    ...
    position = ggplot2::position_stack(vjust = .5),
    size=3.5) +
  ggplot2::ggtitle('Faixa de Idade x Atuação x Gênero')+
  ggplot2::theme_void()+
  ggplot2::scale_fill_brewer(type = "seq", palette = "Reds")+
  ggplot2::xlab('Gênero')+
  ggplot2::theme(legend.position="bottom",
...
```
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
Como dito anteriormente, de acordo com o relatório do State of Data Brazil 2021, as mulheres da área de dados estão ganhando menos nos cargos sênior e de gestão.
Isso poderia ter relação com a maior concentração, proporcionalmente, de mulheres na função que, segundo o relatório da State of Data Brazil 2021, é a que menos paga em todos os níveis de cargo (análise de dados). No entanto,   
ao verificar as atuações, percebemos, entre os cientistas de dados, uma considerável desvantagem das mulheres em relação aos homens nas faixas salariais acima de R$ 16 mil (1,6% x 9,6%), rendimentos geralmente ganhos pelos profissionais sênior, o que indica que a maior proporção de analistas de dados mulheres não é o único fator. Esta diferença é ainda maior entre os engenheiros de dados, embora deva se dizer que ela, muito provavelmente, seja causada pela falta de engenheiras de dados sênior (na base de dados analisada, apenas 7 nesta condição). Apenas entre os analistas de dados é que parece haver equilibrio em termos de salário entre os 2 gêneros.
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
```{r}
...
df%>%
  ...
  ggrepel::geom_label_repel(ggplot2::aes(
    ...
    position = ggplot2::position_stack(vjust = .5),
    size=3.5) +
  ggplot2::labs(title = 'Faixa Salarial x Atuação x Gênero')+
  ggplot2::theme_void()+
...
Com a exclusão dos engenheiros de dados sênior, o equilíbrio salarial entre os gêneros, nesta função, aumenta consideravelmente, mas, ainda sim, quase 6% dos homens entrevistados se encontram nas faixas salariais acima dos 12 mil reais, enquanto que nenhuma mulher (0%) se encontra em tal situação.
...
df%>%
  ...
  ggrepel::geom_label_repel(ggplot2::aes(
    ...
    position = ggplot2::position_stack(vjust = .5),
    size=3.5) +
  ggplot2::labs(title = 'Faixa Salarial dos Engenheiros de Dados Júnior e Pleno x Gênero')+
  ggplot2::theme_void()+
  ggplot2::scale_fill_brewer(type = "seq", palette = "Greens")+
  ggplot2::xlab('Gênero')+
  ggplot2::theme(legend.position="bottom",
