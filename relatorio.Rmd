...
A maior concentração de mulheres na atuação de análise de dados, função, entre as analisadas neste relatório, com os rendimentos mais baixos, embora tenha alguma influência e, com toda a certeza, deva ser melhor investigada, não explica totalmente o fato das mulheres sênior ganharem menos que os homens sênior, pois, além da proporção de engenheiras de dados sênior consideravelmente menor que a dos homens na mesma situação, as cientistas de dados sênior do gênero feminino parecem ganhar menos que os do masculino. Além disso, o gênero feminino, em relação ao masculino, além de estar menos concentrado nos cargos de gestão, possui menores salários, de uma maneira geral. O fator que mais parece explicar esse fenômeno é a considerável derrota das mulheres para os homens em termos de experiências prévias na área de TI, resultado de décadas de exclusão do gênero feminino neste tipo de área. Provavelmente, isso explica, em partes, o por quê das mulheres terem dificuldade em assumir cargos de gerencia ou de liderança, resultando na permanência dos maiores salários nas mãos homens, embora outros fatores devam existir, pois este não é um problema exclusivo da área de dados, como indica o estudo do IBGE anteriormente mencionado.

A menor proporção de mulheres no nível sênior na engenharia de dados também precisa ser investigada. É possível que a falta de experiência prévia em TI tenha alguma influência nisso, mas, aparentemente, há escassez de mulheres mais experientes, de uma maneira geral, entre as engenheiras, pois elas possuem, consideralvelmente, menos experiência na área de dados em comparação aos engenheiros (o que não acontece dentro das outras atuações), além das mulheres serem mais novas que os homens na engenharia de dados.

É preciso destacar a vitória das mulheres em termos de nível de escolaridade.
Em nenhum dos níveis de cargo da para dizer que os homens são mais escolarizados e dá para dizer o mesmo em relação às funções, incluindo a engenharia de dados, onde, mesmo elas sendo mais novas e menos experientes que os homens, possuem, pelo menos, o nível de  pós-graduação em maior proporção que os homens.
