...
```
O curioso é o fato das mulheres serem mais escolarizadas que os homens e quem diz isso é o IBGE. Os dados constam da segunda edição do estudo Estatísticas de gênero: indicadores sociais das mulheres no Brasil. Ele traz informações variadas sobre as condições de vida das brasileiras em 2019  https://epocanegocios.globo.com/Economia/noticia/2021/03/epoca-negocios-mulheres-sao-mais-instruidas-mas-ocupam-apenas-374-dos-cargos-gerenciais.html . O estudo aida trás outros dados, como a maior dificuldade das mulheres em acessar cargos de chefia e gerência (o que, aparentemente, acontece também na área de dados, como mostrado anteriormente), além do rendimento médio inferior a 80% do rendimento dos homens (de acordo com o relatório do State of Data Brazil 2021, as mulheres da área de dados estão ganhando menos nos cargos sênior e de gestão). 
...
Quando analisamos a experiência por nível de cargo, percebe-se, de uma maneira geral, um equilibrio nos cargos pleno e sênior, além de uma leve vantagem para os homens entrevistados nos cargos júnior e de gestor. 
...
```
Entre os cientistas de dados, há equilíbrio entre os gêneros em termos de experiência na área. Já entre os engenheiros de dados, a vantagem é ampla dos homens, sendo 26,79% das mulheres possuindo o mínimo de 4 anos de vivência na área,  enquanto que os homens entrevistados aparecem com 41,3%.
...
```
Uma análise das faixas etárias de cada gênero nos mostra que os homens entrevistados apresentaram idades acima dos 40 com maior proporção (14,4%) que as mulheres (9,5%).
...
Como dito anteriormente, de acordo com o relatório do State of Data Brazil 2021, as mulheres da área de dados estão ganhando menos nos cargos sênior e de gestão. Ao verificar as atuações, percebemos uma considerável desvantagem das mulheres em relação aos homens nas faixas salariais acima de R$ 12 mil (12,5% x 21,8%), rendimentos geralmente ganhos pelos profissionais sênior. Esta diferença é ainda maior entre os engenheiros de dados, embora deva se dizer que ela, muito provavelmente, seja causada pela falta de engenheiras de dados sênior (na base de dados analisada, apenas 7 nesta condição). Apenas entre os analistas de dados é que parece haver equilibrio em termos de salário entre os 2 gêneros.
